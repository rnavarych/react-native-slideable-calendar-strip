      ...
      <View style={styles.itemContainer}>
        ...
        >
          <View style={[
            ...
            {backgroundColor: isHighlight ? highlightBgColor : (highlight ? 'rgb(244, 244, 244)' : normalBgColor)}
          ]}>
            <Text style={[
              styles.itemWeekText,
              {color: isHighlight ? 'white' : 'rgb(34, 34, 34)'}
            ]}>{format(item, 'ddd')}</Text>
            <Text style={[
              styles.itemDateText,
              {color: isHighlight ? 'white' : 'rgb(34, 34, 34)'}
            ]}>{solar}</Text>
        ...
        </TouchableOpacity>
        {
          isHighlight &&
            <TouchableOpacity
                ...
                onPress={removeItem}
            >
              <Image style={styles.closeIcon} source={require('../assets/images/close/close.png')}/>
            </TouchableOpacity>
        }
      </View>
    );
        ...
        <FlatList
          ...
          renderItem={({item}) =>
            <DateItem
              ...
              removeItem={() => onRemoveItem && onRemoveItem(item)}
...
const styles = StyleSheet.create({
  container: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(171, 169, 162, 1)',
  },
  header: {
    height: 30,
    flexDirection: 'row',
